...
struct CoverRowItem_Previews: PreviewProvider {
    static var previews: some View {
        CoverRowItem(cover: CoverArrangementWithDate(coverArrangement: CoverArrangement(originalTeacher: Teacher(initials: "DPC"), coverTeacher: Teacher(initials: "MC"), room: Room.Birley1, lesson: Lesson.Wednesday3rd, divisionCode: "BComV-1", notes: "", isReadingSchool: false), date: Date.now, inSummer: false), vm: CoverPickerViewModel(), isDraftCoverRow: true)
    }
}
